...
public final class TestListFieldTypeNode extends BaseTestNode {

    @Test
    public void testCreateMinimal() {
        new ListFieldTypeNode(
    ...
    public void testGetters() {
        var entryFieldTypeNode = TestFieldTypeNode.createPopulatedTestNode();
        var node = new ListFieldTypeNode(
            BaseTestNode.fileName,
            BaseTestNode.line,
            BaseTestNode.charPosition,
            entryFieldTypeNode
    ...
    public static ListFieldTypeNode createPopulatedTestNode() {
